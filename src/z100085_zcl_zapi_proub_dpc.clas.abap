class Z100085_ZCL_ZAPI_PROUB_DPC definition
  public
...
protected section.
  ...
  methods Z100085_ZCC_PRVD_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type Z100085_ZCL_ZAPI_PROUB_MPC=>TS_Z100085_ZCC_PRVDORGSTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z100085_ZCC_PRVD_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z100085_ZCC_PRVD_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z100085_ZCC_PRVD_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type Z100085_ZCL_ZAPI_PROUB_MPC=>TT_Z100085_ZCC_PRVDORGSTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z100085_ZCC_PRVD_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS Z100085_ZCL_ZAPI_PROUB_DPC IMPLEMENTATION.


  method Z100085_ZCC_PRVD_UPDATE_ENTITY.
  ...
  method Z100085_ZCC_PRVD_GET_ENTITYSET.
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_Z100085_ZCC_PRVDORGS_1 TYPE z100085_zcc_prvdorgs ##NEEDED. " reference for where-used list
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20220421174325
               iv_uuid              = 'Z100085_ZAPI_PROUBC_ORGS'
...
*&* This class has been generated on 04/21/2022 12:43:27 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - Z100085_ZCL_ZAPI_PROUB_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA z100085_zcc_prvd_update_entity TYPE z100085_zcl_zapi_proub_mpc=>ts_z100085_zcc_prvdorgstype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  Z100085_ZCC_PRVDORGS
*-------------------------------------------------------------------------*
      WHEN 'Z100085_ZCC_PRVDORGS'.
*     Call the entity set generated method
          z100085_zcc_prvd_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z100085_zcc_prvd_update_entity
          ).
       IF z100085_zcc_prvd_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z100085_zcc_prvd_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - Z100085_ZCL_ZAPI_PROUB_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA z100085_zcc_prvd_get_entityset TYPE z100085_zcl_zapi_proub_mpc=>tt_z100085_zcc_prvdorgstype.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
   WHEN 'Z100085_ZCC_PRVDORGS'.
*     Call the entity set generated method
      z100085_zcc_prvd_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = z100085_zcc_prvd_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = z100085_zcc_prvd_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z100085_zcc_prvd_get_entity TYPE z100085_zcl_zapi_proub_mpc=>ts_z100085_zcc_prvdorgstype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.       "#EC NEEDED
...
*     Call the entity set generated method
          z100085_zcc_prvd_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z100085_zcc_prvd_get_entity
                         es_response_context = es_response_context
          ).

        IF z100085_zcc_prvd_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z100085_zcc_prvd_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*-------------------------------------------------------------------------*
      when 'Z100085_ZCC_PRVDORGS'.
*     Call the entity set generated method
     z100085_zcc_prvd_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z100085_zcc_prvd_create_entity TYPE z100085_zcl_zapi_proub_mpc=>ts_z100085_zcc_prvdorgstype.
 DATA lv_entityset_name TYPE string.
...
*-------------------------------------------------------------------------*
     WHEN 'Z100085_ZCC_PRVDORGS'.
*     Call the entity set generated method
    z100085_zcc_prvd_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = z100085_zcc_prvd_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = z100085_zcc_prvd_create_entity
      CHANGING
        cr_data = er_entity
   ).
