CLASS z100085_zcl_proubc_api_helper DEFINITION
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      ...
      baseline_health_check IMPORTING iv_tenant      TYPE z100085_prvdtenantid OPTIONAL
                                      iv_subjacct    TYPE z100085_prvdtenantid OPTIONAL
                            EXPORTING ev_isreachable TYPE boolean,
  ...
  PROTECTED SECTION.
    DATA: lv_defaulttenant        TYPE z100085_prvdorgs-organization_id VALUE 'e41dea7b-3510-4ffa-8ff4-53f3b158c8b4',
          lv_defaultsubjaccount   TYPE z100085_prvdtenantid,
...
CLASS z100085_zcl_proubc_api_helper IMPLEMENTATION.
    ...
    IF iv_tenant IS NOT INITIAL AND iv_subject_acct_id IS NOT INITIAL.
      ...
      IF sy-subrc = 0.
        ...
        IF sy-subrc = 0.
          ...
          lv_defaultsubjaccount = wa_defaulttenant-subject_account_id.
  ...
  METHOD call_ident_api.
    ...
    ELSE.
      lv_subjacct = lv_defaultsubjaccount.
    ENDIF.
...
*    CATCH cx_static_check.
  ...
  METHOD baseline_health_check.
    DATA:
      ...
      lv_subjacct     TYPE z100085_prvdtenantid,
...
* raises exception when docker instance of configured bpi instance is down
  ...
  METHOD setup_protocol_msg.
    ...
    me->call_ident_api( EXPORTING iv_tenant = lv_defaulttenant
                                  iv_subjacct = lv_defaultsubjaccount
                      IMPORTING ev_authtoken = lv_tenant_jwt
                                ev_bpiendpoint = lv_bpiendpoint  ).
