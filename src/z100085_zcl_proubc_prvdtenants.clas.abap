...
*        DATA(lv_remaininglength) = 2048 - lv_tokenlength.
          ...
          ENDIF.
        ELSE.
          ls_prvdorg-refresh_token = <fs_olddata>-refresh_token.
          ls_prvdorg-refresh_tokenext = <fs_olddata>-refresh_tokenext.
        ENDIF.
        ls_prvdorg-createdby = <fs_olddata>-createdby.
        ls_prvdorg-created_at = <fs_olddata>-created_at.
        ls_prvdorg-bpi_endpoint = <fs_prvdorg>-bpi_endpoint.
        ls_prvdorg-ident_endpoint = <fs_prvdorg>-ident_endpoint.
        IF ls_prvdorg-bpi_endpoint IS INITIAL.
          ls_prvdorg-bpi_endpoint = <fs_olddata>-bpi_endpoint.
        ENDIF.
        IF ls_prvdorg-ident_endpoint IS INITIAL.
          ls_prvdorg-ident_endpoint = <fs_olddata>-ident_endpoint.
        ENDIF.
    ...
    CHECK lt_prvdorg IS NOT INITIAL.
